...
export function Hero() {
  return (
    <section className="my-5 pt-36">
      <div className="container flex justify-center items-center gap-14">
        <div className="basis-1/2">
          <p className="text-sm font-bold leading-6 text-primary-400 uppercase">Welcome</p>
          <h1 className="text-5xl font-bold leading-snug mt-3">
            India’s Leading Digital Marketing Agency
          </h1>
          <p className="text-xl leading-8 text-primary-300 mt-9">
          ...
          <Button
            className="py-3 px-8 bg-primary-400 text-white rounded-lg mt-8 text-lg font-bold block w-fit"
            Btntext="Book Demo"
            href="#book-demo"
          />
        </div>
        <div className="basis-1/2 bg-primary-700 rounded-3xl">
