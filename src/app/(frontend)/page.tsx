...
export async function generateMetadata() {
  const metadata = await getMeta({
    ...
    fallback: {
      ...
      description:
        'A growth marketing agency in Kochi running SEO, AI citations, demand generation, content and analytics for brands across Kerala and India. Free 30-minute growth call.',
    },
  });
  return metadata;
}
