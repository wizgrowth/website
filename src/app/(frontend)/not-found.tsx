// The global 404: reached through the [...missing] catch-all, so it renders
// inside the (frontend) root layout (lang, analytics, metadata) rather than
// Next's bare default document. It deliberately imports no global stylesheet:
// anything imported here is injected on every page of the site, and the
// design systems' stylesheets must never meet. Its styles are scoped under
// .nf-*. Pages that call notFound() inside a route group render that group's
// own not-found.tsx, with the full chrome.
export const metadata = {
  title: 'Page not found',
  description: 'The page you asked for is not here. Start from the WizGrowth home page.',
