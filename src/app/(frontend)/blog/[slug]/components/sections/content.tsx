  ...
  return (
    <section className="mt-24 mb-16 max-md:mt-16">
      <div className="container flex items-start gap-10">
        {innerData?.sideMenu && innerData?.sideMenu.length > 0 && (
          <div
            id="blog-floating-menu"
            className="basis-1/4  sticky top-40 [&>div>div>.active]:bg-primary-200 max-md:hidden"
          >
            <div>
