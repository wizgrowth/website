          ...
          <div className="flex flex-col gap-3.5">
            {items.map((item) => (
              <Reveal key={item.id ?? item.question}>
                <details className="article-qa rounded-2xl border border-[rgba(14,23,21,0.16)] bg-[rgba(20,53,42,0.04)] px-7 transition-colors open:border-[rgba(14,23,21,0.32)] hover:border-[rgba(14,23,21,0.32)] max-[720px]:px-5">
