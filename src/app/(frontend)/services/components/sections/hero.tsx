  ...
  return (
    <section>
      <div className="container">
        <div className="mt-40 bg-primary-200 rounded-3xl flex items-center justify-evenly max-xl:lg:gap-20 max-lg:py-10 max-lg:px-10 ">
          <Image
          ...
          />
          <div>
            <h1 className="font-extrabold text-5xl leading-tight text-black max-lg:text-center max-lg:text-4xl max-lg:leading-snug">
